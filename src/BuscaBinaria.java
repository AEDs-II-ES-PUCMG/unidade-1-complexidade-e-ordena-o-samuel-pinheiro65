...
public class BuscaBinaria {
    ...
    public static Produto buscarPorId(Produto[] produtos, int idProcurado) {
        ...
        while (esquerda <= direita) {
            ...
            int idMeio = produtos[meio].getId();
    ...
    /**
     * Busca binária por descrição do produto
     * @param produtos Array de produtos ordenado por descrição
     * @param descricaoProcurada Descrição do produto a ser procurado
     * @return O produto se encontrado, null caso contrário
     */
    public static Produto buscarPorDescricao(Produto[] produtos, String descricaoProcurada) {
        if (produtos == null || produtos.length == 0 || descricaoProcurada == null) {
            return null;
        }
        ...
        while (esquerda <= direita) {
            int meio = esquerda + (direita - esquerda) / 2;
            int comparacao = produtos[meio].getDescricao().compareTo(descricaoProcurada);
